...
I enjoy building practical, real-world engineering solutions that improve lives.

---

## 🎓 Education
- **BSc.(Hons) in Biomedical Engineering** – University of Moratuwa  (Dean's list - semester 1 and 2)
- **GCE Advanced Level** – Combined Maths, Physics, Chemistry (Distinction of 3A's, Island rank = 407, Z-score = 2.3330, Merit Level Pass)  
- **ACCA** – Knowledge Level (Ongoing)
...
- PCB Design (Beginner–Intermediate)
...
### 🪑 P.A.P.A.Y.A – Smart Posture Monitoring Cushion
- Real-time posture detection using FSR sensors
- Vibrotactile feedback for posture correction
- Arduino-based system with custom PCB
- 🏆 *2nd Runners Up – Brainstorm 2025*

🔗 [Project Repository](https://github.com/Abdul-Rahman-bme/PulseCode-Posture-Cushion-P.A.P.A.Y.A-)
...
- 💼 LinkedIn: www.linkedin.com/in/abdul-rahman-m-005811249
